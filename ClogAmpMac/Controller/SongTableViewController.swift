    ...
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        ...
        if let cell = tableView.makeView(withIdentifier: tableColumn!.identifier, owner: nil) as? NSTableCellView {
            ...
            if Settings.songTableMonoFont {
                textField.font = NSFont.init(name: Settings.monoFontName, size: CGFloat(Settings.songTableFontSize))
            } else {
                textField.font = NSFont(name: Settings.proportionalFontName, size: CGFloat(Settings.songTableFontSize)) ?? NSFont.systemFont(ofSize: CGFloat(Settings.songTableFontSize))
            }
